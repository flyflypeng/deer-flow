...
- If you need to handle multiple subtasks, please process them one by one serially, and wait for all tasks to be completed before proceeding to other steps.
